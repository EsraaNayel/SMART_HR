 ...
 */
public class RequestExceptionActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_request_exception);
...
//                mDatePickerDialog.setTitle("بتاريخ");
//                mDatePickerDialog.show();
                ...
                DatePickerDialog dialog =
                        new DatePickerDialog(RequestExceptionActivity.this, mDateSetListener, mYear, mMonth, mDay);
                dialog.show();
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RequestExceptionActivity.this, FilterExceptionsActivity.class);
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RequestExceptionActivity.this, MainActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(intent);
                finish();
            }
